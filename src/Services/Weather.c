...
static void __lambda13_ (Weather* self, SoupSession* session, SoupMessage* m) {
	...
	today = _tmp48_;
	_tmp49_ = today;
	_tmp50_ = g_strconcat ("<span color='" textcolor "' face='Open Sans Light' font='24'>", _tmp49_, NULL);
	_tmp51_ = _tmp50_;
	_tmp52_ = g_strconcat (_tmp51_, "</span>", NULL);
	_tmp53_ = _tmp52_;
	_tmp54_ = g_strconcat (_tmp53_, "<span color='", NULL);
	_tmp55_ = _tmp54_;
	_tmp56_ = g_strconcat (_tmp55_, textcolor, NULL);
	_tmp57_ = _tmp56_;
	_tmp58_ = g_strconcat (_tmp57_, "' face='Open Sans Light' font='16'> // <i>", NULL);
	_tmp59_ = _tmp58_;
	_tmp60_ = self->priv->condition_texts;
	_tmp60__length1 = self->priv->condition_texts_length1;
	_tmp61_ = current;
	_tmp61__length1 = current_length1;
	_tmp62_ = _tmp61_[2];
	_tmp63_ = atoi (_tmp62_);
	_tmp64_ = _tmp60_[_tmp63_];
	_tmp65_ = g_strconcat (_tmp59_, _tmp64_, NULL);
	_tmp66_ = _tmp65_;
	_tmp67_ = g_strconcat (_tmp66_, "</i></span>\n", NULL);
	_tmp68_ = _tmp67_;
	_tmp69_ = g_strconcat (_tmp68_, "<span color='", NULL);
	_tmp70_ = _tmp69_;
	_tmp71_ = g_strconcat (_tmp70_, textcolor, NULL);
	_tmp72_ = _tmp71_;
	_tmp73_ = g_strconcat (_tmp72_, "' face='gazetteweather' font='68'>", NULL);
	_tmp74_ = _tmp73_;
	_tmp75_ = current;
	_tmp75__length1 = current_length1;
	_tmp76_ = _tmp75_[2];
	_tmp77_ = atoi (_tmp76_);
	_tmp78_ = condition_codes[_tmp77_];
	_tmp79_ = g_strconcat (_tmp74_, _tmp78_, NULL);
	_tmp80_ = _tmp79_;
	_tmp81_ = g_strconcat (_tmp80_, "</span>", NULL);
	_tmp82_ = _tmp81_;
	_tmp83_ = g_strconcat (_tmp82_, "<span color='", NULL);
	_tmp84_ = _tmp83_;
	_tmp85_ = g_strconcat (_tmp84_, textcolor, NULL);
	_tmp86_ = _tmp85_;
	_tmp87_ = g_strconcat (_tmp86_, "' face='Raleway' weight='100' font='72'> ", NULL);
	_tmp88_ = _tmp87_;
	_tmp89_ = current;
	_tmp89__length1 = current_length1;
	_tmp90_ = _tmp89_[0];
	_tmp91_ = g_strconcat (_tmp88_, _tmp90_, NULL);
	_tmp92_ = _tmp91_;
	_tmp93_ = g_strconcat (_tmp92_, "</span>", NULL);
	_tmp94_ = _tmp93_;
	_tmp95_ = g_strconcat (_tmp94_, "<span color='", NULL);
	_tmp96_ = _tmp95_;
	_tmp97_ = g_strconcat (_tmp96_, textcolor, NULL);
	_tmp98_ = _tmp97_;
	_tmp99_ = g_strconcat (_tmp98_, "' face='Raleway' weight='100' font='40'> ° ", NULL);
	_tmp100_ = _tmp99_;
	_tmp101_ = self->priv->unit;
	_tmp102_ = g_utf8_strup (_tmp101_, (gssize) (-1));
	_tmp103_ = _tmp102_;
	_tmp104_ = g_strconcat (_tmp100_, _tmp103_, NULL);
	_tmp105_ = _tmp104_;
	_tmp106_ = g_strconcat (_tmp105_, "</span>\n", NULL);
	_tmp107_ = _tmp106_;
	_tmp108_ = g_strconcat (_tmp107_, "<span color='", NULL);
	_tmp109_ = _tmp108_;
	_tmp110_ = g_strconcat (_tmp109_, textcolor, NULL);
	_tmp111_ = _tmp110_;
	_tmp112_ = g_strconcat (_tmp111_, "' face='gazetteweather' font='30'>", NULL);
	_tmp113_ = _tmp112_;
	_tmp114_ = forecast;
	_tmp114__length1 = forecast_length1;
	_tmp115_ = _tmp114_[5];
	_tmp116_ = atoi (_tmp115_);
	_tmp117_ = condition_codes[_tmp116_];
	_tmp118_ = g_strconcat (_tmp113_, _tmp117_, NULL);
	_tmp119_ = _tmp118_;
	_tmp120_ = g_strconcat (_tmp119_, "</span>", NULL);
	_tmp121_ = _tmp120_;
	_tmp122_ = g_strconcat (_tmp121_, "<span color='", NULL);
	_tmp123_ = _tmp122_;
	_tmp124_ = g_strconcat (_tmp123_, textcolor, NULL);
	_tmp125_ = _tmp124_;
	_tmp126_ = g_strconcat (_tmp125_, "' face='Open Sans Light' font='26'> ", NULL);
	_tmp127_ = _tmp126_;
	_tmp128_ = forecast;
	_tmp128__length1 = forecast_length1;
	_tmp129_ = _tmp128_[0];
	_tmp130_ = _ (_tmp129_);
	_tmp131_ = g_strconcat (_tmp127_, _tmp130_, NULL);
	_tmp132_ = _tmp131_;
	_tmp133_ = g_strconcat (_tmp132_, "     </span>", NULL);
	_tmp134_ = _tmp133_;
	_tmp135_ = g_strconcat (_tmp134_, "<span color='", NULL);
	_tmp136_ = _tmp135_;
	_tmp137_ = g_strconcat (_tmp136_, textcolor, NULL);
	_tmp138_ = _tmp137_;
	_tmp139_ = g_strconcat (_tmp138_, "' face='gazetteweather' font='30'>", NULL);
	_tmp140_ = _tmp139_;
	_tmp141_ = forecast2;
	_tmp141__length1 = forecast2_length1;
	_tmp142_ = _tmp141_[5];
	_tmp143_ = atoi (_tmp142_);
	_tmp144_ = condition_codes[_tmp143_];
	_tmp145_ = g_strconcat (_tmp140_, _tmp144_, NULL);
	_tmp146_ = _tmp145_;
	_tmp147_ = g_strconcat (_tmp146_, "</span>", NULL);
	_tmp148_ = _tmp147_;
	_tmp149_ = g_strconcat (_tmp148_, "<span color='", NULL);
	_tmp150_ = _tmp149_;
	_tmp151_ = g_strconcat (_tmp150_, textcolor, NULL);
	_tmp152_ = _tmp151_;
	_tmp153_ = g_strconcat (_tmp152_, "' face='Open Sans Light' font='26'> ", NULL);
	_tmp154_ = _tmp153_;
	_tmp155_ = forecast2;
	_tmp155__length1 = forecast2_length1;
	_tmp156_ = _tmp155_[0];
	_tmp157_ = _ (_tmp156_);
	_tmp158_ = g_strconcat (_tmp154_, _tmp157_, NULL);
	_tmp159_ = _tmp158_;
	_tmp160_ = g_strconcat (_tmp159_, "</span>\n", NULL);
	_tmp161_ = _tmp160_;
	_tmp162_ = g_strconcat (_tmp161_, "<span color='", NULL);
	_tmp163_ = _tmp162_;
	_tmp164_ = g_strconcat (_tmp163_, textcolor, NULL);
	_tmp165_ = _tmp164_;
	_tmp166_ = g_strconcat (_tmp165_, "' face='Raleway' font='21'>", NULL);
	_tmp167_ = _tmp166_;
	_tmp168_ = forecast;
	_tmp168__length1 = forecast_length1;
	_tmp169_ = _tmp168_[2];
	...
	_tmp173_ = _tmp172_;
	_tmp174_ = forecast;
	_tmp174__length1 = forecast_length1;
	_tmp175_ = _tmp174_[3];
	_tmp176_ = g_strconcat (_tmp173_, _tmp175_, NULL);
	_tmp177_ = _tmp176_;
	_tmp178_ = g_strconcat (_tmp177_, "°", NULL);
	_tmp179_ = _tmp178_;
	_tmp180_ = self->priv->unit;
	_tmp181_ = g_utf8_strup (_tmp180_, (gssize) (-1));
	_tmp182_ = _tmp181_;
	_tmp183_ = g_strconcat (_tmp179_, _tmp182_, NULL);
	_tmp184_ = _tmp183_;
	_tmp185_ = g_strconcat (_tmp184_, "      </span>", NULL);
	_tmp186_ = _tmp185_;
	_tmp187_ = g_strconcat (_tmp186_, "<span color='", NULL);
	_tmp188_ = _tmp187_;
	_tmp189_ = g_strconcat (_tmp188_, textcolor, NULL);
	_tmp190_ = _tmp189_;
	_tmp191_ = g_strconcat (_tmp190_, "' face='Raleway' font='21'>", NULL);
	_tmp192_ = _tmp191_;
	_tmp193_ = forecast2;
	_tmp193__length1 = forecast2_length1;
	_tmp194_ = _tmp193_[2];
	_tmp195_ = g_strconcat (_tmp192_, _tmp194_, NULL);
	_tmp196_ = _tmp195_;
	_tmp197_ = g_strconcat (_tmp196_, " - ", NULL);
	_tmp198_ = _tmp197_;
	_tmp199_ = forecast2;
	_tmp199__length1 = forecast2_length1;
	_tmp200_ = _tmp199_[3];
	_tmp201_ = g_strconcat (_tmp198_, _tmp200_, NULL);
	_tmp202_ = _tmp201_;
	_tmp203_ = g_strconcat (_tmp202_, "°", NULL);
	_tmp204_ = _tmp203_;
	_tmp205_ = self->priv->unit;
	_tmp206_ = g_utf8_strup (_tmp205_, (gssize) (-1));
	_tmp207_ = _tmp206_;
	_tmp208_ = g_strconcat (_tmp204_, _tmp207_, NULL);
	_tmp209_ = _tmp208_;
	_tmp210_ = g_strconcat (_tmp209_, "      </span>", NULL);
	_g_free0 (self->priv->text);
	self->priv->text = _tmp210_;
	_g_free0 (_tmp209_);
	_g_free0 (_tmp207_);
	_g_free0 (_tmp204_);
	_g_free0 (_tmp202_);
	...
	_g_free0 (_tmp53_);
	_g_free0 (_tmp51_);
	_tmp211_ = self->priv->label;
	_tmp212_ = self->priv->text;
	shadowed_label_set_label (_tmp211_, _tmp212_);
	_g_free0 (today);
...
static gboolean weather_real_update (Service* base) {
	...
	_tmp2_ = _ ("Loading weather,\nplease wait.");
	_tmp3_ = g_strconcat ("<span color='" textcolor "' face='Open Sans Light' font='16'>", _tmp2_, NULL);
	_tmp4_ = _tmp3_;
	_tmp5_ = g_strconcat (_tmp4_, "</span>", NULL);
	_tmp6_ = _tmp5_;
	shadowed_label_set_label (_tmp1_, _tmp6_);
	_g_free0 (_tmp6_);
	_g_free0 (_tmp4_);
	_tmp7_ = self->priv->label;
	clutter_actor_show ((ClutterActor*) _tmp7_);
	_tmp8_ = self->priv->settings;
	_tmp9_ = g_settings_get_int (_tmp8_, "weather-id");
	_tmp10_ = g_strdup_printf ("%i", _tmp9_);
	id = _tmp10_;
	_tmp12_ = self->priv->settings;
	_tmp13_ = g_settings_get_string (_tmp12_, "weather-unit");
	_tmp14_ = _tmp13_;
	_tmp15_ = g_strcmp0 (_tmp14_, "Fahrenheit") == 0;
	_g_free0 (_tmp14_);
	if (_tmp15_) {
		_tmp11_ = "f";
	} else {
	...
	self->priv->unit = _tmp17_;
	_tmp18_ = g_strdup ("http://weather.yahooapis.com/forecastrss");
	url = _tmp18_;
	_tmp19_ = url;
	_tmp20_ = self->priv->unit;
	_tmp21_ = g_strconcat ("?u=", _tmp20_, NULL);
	_tmp22_ = _tmp21_;
	...
	_tmp24_ = url;
	_tmp25_ = id;
	_tmp26_ = g_strconcat ("&w=", _tmp25_, NULL);
	_tmp27_ = _tmp26_;
	...
	_g_free0 (_tmp27_);
	_tmp29_ = url;
	_tmp30_ = soup_message_new ("GET", _tmp29_);
	_g_object_unref0 (self->priv->message);
	self->priv->message = _tmp30_;
	_tmp31_ = self->priv->session;
	_tmp32_ = self->priv->message;
	_tmp33_ = _g_object_ref0 (_tmp32_);
	soup_session_queue_message ((SoupSession*) _tmp31_, _tmp33_, ___lambda13__soup_session_callback, self);
	result = TRUE;
	_g_free0 (url);
	_g_free0 (id);
	return result;
