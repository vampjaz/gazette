...
static void __lambda13_ (Weather* self, SoupSession* session, SoupMessage* m) {
	...
	today = _tmp48_;
	_tmp49_ = today;
	_tmp50_ = g_strconcat ("<span face='Open Sans Light' font='24' color='black'>", _tmp49_, NULL);
	_tmp51_ = _tmp50_;
	_tmp52_ = g_strconcat (_tmp51_, "</span>", NULL);
	_tmp53_ = _tmp52_;
	_tmp54_ = g_strconcat (_tmp53_, "<span face='Open Sans Light' font='16' color='black'> // <i>", NULL);
	_tmp55_ = _tmp54_;
	_tmp56_ = self->priv->condition_texts;
	_tmp56__length1 = self->priv->condition_texts_length1;
	_tmp57_ = current;
	_tmp57__length1 = current_length1;
	_tmp58_ = _tmp57_[2];
	_tmp59_ = atoi (_tmp58_);
	_tmp60_ = _tmp56_[_tmp59_];
	_tmp61_ = g_strconcat (_tmp55_, _tmp60_, NULL);
	_tmp62_ = _tmp61_;
	_tmp63_ = g_strconcat (_tmp62_, "</i></span>\n", NULL);
	_tmp64_ = _tmp63_;
	_tmp65_ = g_strconcat (_tmp64_, "<span face='gazetteweather' font='68' color='black'>", NULL);
	_tmp66_ = _tmp65_;
	_tmp67_ = current;
	_tmp67__length1 = current_length1;
	_tmp68_ = _tmp67_[2];
	_tmp69_ = atoi (_tmp68_);
	_tmp70_ = condition_codes[_tmp69_];
	_tmp71_ = g_strconcat (_tmp66_, _tmp70_, NULL);
	_tmp72_ = _tmp71_;
	_tmp73_ = g_strconcat (_tmp72_, "</span>", NULL);
	_tmp74_ = _tmp73_;
	_tmp75_ = g_strconcat (_tmp74_, "<span face='Raleway' weight='100' font='72' color='black'> ", NULL);
	_tmp76_ = _tmp75_;
	_tmp77_ = current;
	_tmp77__length1 = current_length1;
	_tmp78_ = _tmp77_[0];
	_tmp79_ = g_strconcat (_tmp76_, _tmp78_, NULL);
	_tmp80_ = _tmp79_;
	_tmp81_ = g_strconcat (_tmp80_, "</span>", NULL);
	_tmp82_ = _tmp81_;
	_tmp83_ = g_strconcat (_tmp82_, "<span face='Raleway' weight='100' font='40' color='black'> ° ", NULL);
	_tmp84_ = _tmp83_;
	_tmp85_ = self->priv->unit;
	_tmp86_ = g_utf8_strup (_tmp85_, (gssize) (-1));
	_tmp87_ = _tmp86_;
	_tmp88_ = g_strconcat (_tmp84_, _tmp87_, NULL);
	_tmp89_ = _tmp88_;
	_tmp90_ = g_strconcat (_tmp89_, "</span>\n", NULL);
	_tmp91_ = _tmp90_;
	_tmp92_ = g_strconcat (_tmp91_, "<span face='gazetteweather' font='30' color='black'>", NULL);
	_tmp93_ = _tmp92_;
	_tmp94_ = forecast;
	_tmp94__length1 = forecast_length1;
	_tmp95_ = _tmp94_[5];
	_tmp96_ = atoi (_tmp95_);
	_tmp97_ = condition_codes[_tmp96_];
	_tmp98_ = g_strconcat (_tmp93_, _tmp97_, NULL);
	_tmp99_ = _tmp98_;
	_tmp100_ = g_strconcat (_tmp99_, "</span>", NULL);
	_tmp101_ = _tmp100_;
	_tmp102_ = g_strconcat (_tmp101_, "<span face='Open Sans Light' font='26' color='black'> ", NULL);
	_tmp103_ = _tmp102_;
	_tmp104_ = forecast;
	_tmp104__length1 = forecast_length1;
	_tmp105_ = _tmp104_[0];
	_tmp106_ = _ (_tmp105_);
	_tmp107_ = g_strconcat (_tmp103_, _tmp106_, NULL);
	_tmp108_ = _tmp107_;
	_tmp109_ = g_strconcat (_tmp108_, "     </span>", NULL);
	_tmp110_ = _tmp109_;
	_tmp111_ = g_strconcat (_tmp110_, "<span face='gazetteweather' font='30' color='black'>", NULL);
	_tmp112_ = _tmp111_;
	_tmp113_ = forecast2;
	_tmp113__length1 = forecast2_length1;
	_tmp114_ = _tmp113_[5];
	_tmp115_ = atoi (_tmp114_);
	_tmp116_ = condition_codes[_tmp115_];
	_tmp117_ = g_strconcat (_tmp112_, _tmp116_, NULL);
	_tmp118_ = _tmp117_;
	_tmp119_ = g_strconcat (_tmp118_, "</span>", NULL);
	_tmp120_ = _tmp119_;
	_tmp121_ = g_strconcat (_tmp120_, "<span face='Open Sans Light' font='26' color='black'> ", NULL);
	_tmp122_ = _tmp121_;
	_tmp123_ = forecast2;
	_tmp123__length1 = forecast2_length1;
	_tmp124_ = _tmp123_[0];
	_tmp125_ = _ (_tmp124_);
	_tmp126_ = g_strconcat (_tmp122_, _tmp125_, NULL);
	_tmp127_ = _tmp126_;
	_tmp128_ = g_strconcat (_tmp127_, "</span>\n", NULL);
	_tmp129_ = _tmp128_;
	_tmp130_ = g_strconcat (_tmp129_, "<span face='Raleway' font='21' color='black'>", NULL);
	_tmp131_ = _tmp130_;
	_tmp132_ = forecast;
	_tmp132__length1 = forecast_length1;
	_tmp133_ = _tmp132_[2];
	...
	_tmp137_ = _tmp136_;
	_tmp138_ = forecast;
	_tmp138__length1 = forecast_length1;
	_tmp139_ = _tmp138_[3];
	_tmp140_ = g_strconcat (_tmp137_, _tmp139_, NULL);
	_tmp141_ = _tmp140_;
	_tmp142_ = g_strconcat (_tmp141_, "°", NULL);
	_tmp143_ = _tmp142_;
	_tmp144_ = self->priv->unit;
	_tmp145_ = g_utf8_strup (_tmp144_, (gssize) (-1));
	_tmp146_ = _tmp145_;
	_tmp147_ = g_strconcat (_tmp143_, _tmp146_, NULL);
	_tmp148_ = _tmp147_;
	_tmp149_ = g_strconcat (_tmp148_, "      </span>", NULL);
	_tmp150_ = _tmp149_;
	_tmp151_ = g_strconcat (_tmp150_, "<span face='Raleway' font='21' color='black'>", NULL);
	_tmp152_ = _tmp151_;
	_tmp153_ = forecast2;
	...
	_tmp158_ = _tmp157_;
	_tmp159_ = forecast2;
	_tmp159__length1 = forecast2_length1;
	_tmp160_ = _tmp159_[3];
	_tmp161_ = g_strconcat (_tmp158_, _tmp160_, NULL);
	_tmp162_ = _tmp161_;
	_tmp163_ = g_strconcat (_tmp162_, "°", NULL);
	_tmp164_ = _tmp163_;
	_tmp165_ = self->priv->unit;
	_tmp166_ = g_utf8_strup (_tmp165_, (gssize) (-1));
	_tmp167_ = _tmp166_;
	_tmp168_ = g_strconcat (_tmp164_, _tmp167_, NULL);
	_tmp169_ = _tmp168_;
	_tmp170_ = g_strconcat (_tmp169_, "      </span>", NULL);
	_g_free0 (self->priv->text);
	self->priv->text = _tmp170_;
	_g_free0 (_tmp169_);
	_g_free0 (_tmp167_);
	_g_free0 (_tmp164_);
	_g_free0 (_tmp162_);
	...
	_g_free0 (_tmp53_);
	_g_free0 (_tmp51_);
	_tmp171_ = self->priv->label;
	_tmp172_ = self->priv->text;
	shadowed_label_set_label (_tmp171_, _tmp172_);
	_g_free0 (today);
...
static gboolean weather_real_update (Service* base) {
	...
	_tmp3_ = g_strconcat ("<span face='Open Sans Light' font='16'  color='black'>", _tmp2_, NULL);
	_tmp4_ = _tmp3_;
