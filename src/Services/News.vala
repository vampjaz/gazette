...
public class News : Service
{
	...
	public News ()
	{
		...
		var label = new ShadowedLabel ("<span font='20' face='Raleway' color='%s'".printf (_(textcolor)) + ">%s</span>".printf (_("News")));
	...
	{   debug("Updating News");
	    ...
	    label_list.show();
	    label_list.label = "<span face='Open Sans Light' font='16' color='%s'".printf (_(textcolor)) + ">" + _("Loading news,\nplease wait.") + "</span>";
	    ...
	    session.queue_message (message, (session, m) => 
	    {
		    ...
		    var list = "<span font='12' face='Open Sans' color='%s'".printf (_(textcolor)) + ">";
