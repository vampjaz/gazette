...
public class Files : Service
{
	...
	{
		var files_label = new ShadowedLabel ("<span font='20' face='Raleway' color='%s'".printf (_(textcolor)) + ">%s</span>".printf (_("Files")));
	...
	public override bool update ()
	{
		...
		var res = "<span font='12' face='Open Sans' color='%s'".printf (_(textcolor)) + ">";
