...
News* news_construct (GType object_type) {
	...
	_tmp12_ = _ ("News");
	_tmp13_ = g_strdup_printf ("<span font='20' face='Raleway' color='black'>%s</span>", _tmp12_);
	_tmp14_ = _tmp13_;
	_tmp15_ = shadowed_label_new (_tmp14_);
	g_object_ref_sink (_tmp15_);
	_tmp16_ = _tmp15_;
	_g_free0 (_tmp14_);
	label = _tmp16_;
	_tmp17_ = self->priv->label_list;
	_tmp18_ = clutter_actor_get_height ((ClutterActor*) label);
	_tmp19_ = _tmp18_;
	clutter_actor_set_y ((ClutterActor*) _tmp17_, _tmp19_ + 12);
	_tmp20_ = self->priv->label_list;
	clutter_actor_set_x ((ClutterActor*) _tmp20_, (gfloat) 12);
	_tmp21_ = self->priv->reload;
	_tmp22_ = self->priv->label_list;
	_tmp23_ = clutter_actor_get_y ((ClutterActor*) _tmp22_);
	_tmp24_ = _tmp23_;
	clutter_actor_set_y ((ClutterActor*) _tmp21_, _tmp24_);
	_tmp25_ = self->priv->reload;
	_tmp26_ = self->priv->label_list;
	_tmp27_ = clutter_actor_get_x ((ClutterActor*) _tmp26_);
	_tmp28_ = _tmp27_;
	clutter_actor_set_x ((ClutterActor*) _tmp25_, _tmp28_);
	clutter_actor_add_child ((ClutterActor*) self, (ClutterActor*) label);
	_tmp29_ = self->priv->reload;
	clutter_actor_add_child ((ClutterActor*) self, (ClutterActor*) _tmp29_);
	_tmp30_ = self->priv->label_list;
...
static void __lambda16_ (News* self, SoupSession* session, SoupMessage* m) {
	...
	_tmp42_ = g_strdup ("<span font='12' face='Open Sans' color='black'>");
	list = _tmp42_;
	{
		gint i;
		i = 0;
...
static gboolean news_real_update (Service* base) {
	...
	_tmp5_ = g_strconcat ("<span face='Open Sans Light' font='16' color='black'>", _tmp4_, NULL);
	_tmp6_ = _tmp5_;
